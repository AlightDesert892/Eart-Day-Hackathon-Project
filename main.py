...
print("If you land on waste, you go back some blocks.")
print("If you land on a tree, you go up some blocks.")
...
colorB = 33
if hmb > 24 and hmb < 99:
  tree.goto(numTurtDict[str(l1[0] - 1)])
  ...
  tree.goto(numTurtDict[str(l2[0] - 1)])
  ...
  colorG = 216
  colorB = 145
  tree.goto(numTurtDict[str(s1[0] - 1)])
  ...
  tree.goto(numTurtDict[str(s2[0] - 1)])
  ...
  tree.goto(numTurtDict[str(l2[0] - 1)])
  logsOrWater(Distance(tree.xcor(), tree.ycor(), numTurtDict[str(l2[1] - 1)].xcor(), numTurtDict[str(l2[1] - 1)].ycor()), numTurtDict[str(l2[1] - 1)], colorR, colorG, colorB)
  tree.goto(numTurtDict[str(l3[0] - 1)])
  ...
  tree.goto(numTurtDict[str(l4[0] - 1)])
  ...
  tree.goto(numTurtDict[str(s2[0] - 1)])
  logsOrWater(Distance(tree.xcor(), tree.ycor(), numTurtDict[str(s2[1] - 1)].xcor(), numTurtDict[str(s2[1] - 1)].ycor()), numTurtDict[str(s2[1] - 1)], colorR, colorG, colorB)
  tree.goto(numTurtDict[str(s3[0] - 1)])
  ...
  tree.goto(numTurtDict[str(s4[0] - 1)])
  ...
  tree.goto(numTurtDict[str(l4[0] - 1)])
  logsOrWater(Distance(tree.xcor(), tree.ycor(), numTurtDict[str(l4[1] - 1)].xcor(), numTurtDict[str(l4[1] - 1)].ycor()), numTurtDict[str(l4[1] - 1)], colorR, colorG, colorB)
  tree.goto(numTurtDict[str(l5[0] - 1)])
  ...
  tree.goto(numTurtDict[str(l6[0] - 1)])
  ...
  tree.goto(numTurtDict[str(s4[0] - 1)])
  logsOrWater(Distance(tree.xcor(), tree.ycor(), numTurtDict[str(s4[1] - 1)].xcor(), numTurtDict[str(s4[1] - 1)].ycor()), numTurtDict[str(s4[1] - 1)], colorR, colorG, colorB)
  tree.goto(numTurtDict[str(s5[0] - 1)])
  ...
  tree.goto(numTurtDict[str(s6[0] - 1)])
  ...
  tree.goto(numTurtDict[str(l6[0] - 1)])
  logsOrWater(Distance(tree.xcor(), tree.ycor(), numTurtDict[str(l6[1] - 1)].xcor(), numTurtDict[str(l6[1] - 1)].ycor()), numTurtDict[str(l6[1] - 1)], colorR, colorG, colorB)
  tree.goto(numTurtDict[str(l7[0] - 1)])
  ...
  tree.goto(numTurtDict[str(l8[0] - 1)])
  ...
  tree.goto(numTurtDict[str(s6[0] - 1)])
  logsOrWater(Distance(tree.xcor(), tree.ycor(), numTurtDict[str(s6[1] - 1)].xcor(), numTurtDict[str(s6[1] - 1)].ycor()), numTurtDict[str(s6[1] - 1)], colorR, colorG, colorB)
  tree.goto(numTurtDict[str(s7[0] - 1)])
  ...
  tree.goto(numTurtDict[str(s8[0] - 1)])
  ...
  tree.goto(numTurtDict[str(l8[0] - 1)])
  logsOrWater(Distance(tree.xcor(), tree.ycor(), numTurtDict[str(l8[1] - 1)].xcor(), numTurtDict[str(l8[1] - 1)].ycor()), numTurtDict[str(l8[1] - 1)], colorR, colorG, colorB)
  tree.goto(numTurtDict[str(l9[0] - 1)])
  ...
  tree.goto(numTurtDict[str(l10[0] - 1)])
  ...
  tree.goto(numTurtDict[str(s8[0] - 1)])
  logsOrWater(Distance(tree.xcor(), tree.ycor(), numTurtDict[str(s8[1] - 1)].xcor(), numTurtDict[str(s8[1] - 1)].ycor()), numTurtDict[str(s8[1] - 1)], colorR, colorG, colorB)
  tree.goto(numTurtDict[str(s9[0] - 1)])
  ...
  tree.goto(numTurtDict[str(s10[0] - 1)])
...
p2turt.penup()
p2turt.shape('turtle')
p1turt.goto(numTurtDict[str(0)])
p2turt.goto(numTurtDict[str(0)])
...
while p1 < hmb and p2 < hmb:
  ...
  p1turt.goto(numTurtDict[str(p1 - 1)])
  if p1 == hmb:
    break
  ...
  p2turt.goto(numTurtDict[str(p2 - 1)])
  if p2 == hmb:
    break
...
print('Please remember to go to https://repl.it/@AlightDesert892/Earth-Day-Hackathon-2nd-Part after you finish this for the second part.')
#Please remember to go to https://repl.it/@AlightDesert892/Earth-Day-Hackathon-2nd-Part after you finish this for the second part.